...
args = ARGS(epochs=50, batch_size=8, lr=0.00001, inp_size=360, use_cuda=True, val_every=2000, save_at_end=True, save_freq=5, step_size=40, gamma=0.1, test_batch_size=10)
