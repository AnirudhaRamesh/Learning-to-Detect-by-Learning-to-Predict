...
def main(args=None):
    ...
    if parser.log : 
        wandb.init(project="vlr-project-detector-{}".format(parser.model_name), reinit=True)
    ...
    for epoch_num in range(parser.epochs):
        ...
        torch.save(retinanet.module, 'checkpoints/{}/{}_retinanet_{}.pt'.format(parser.model_name, parser.dataset, epoch_num))

    retinanet.eval()

    torch.save(retinanet, 'checkpoints/{}/model_final.pt'.format(parser.model_name))
